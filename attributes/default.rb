...
default['cassandra']['opscenter']['version'] = '5.1.4'
...
default['cassandra']['opscenter']['server']['authentication'] = true

default['cassandra']['opscenter']['agent']['version'] = '5.2.4'
default['cassandra']['opscenter']['agent']['package_name'] = 'datastax-agent'
default['cassandra']['opscenter']['agent']['download_url'] = "http://downloads.datastax.com/community/datastax-agent-#{node['cassandra']['opscenter']['agent']['version']}.tar.gz"
default['cassandra']['opscenter']['agent']['checksum'] = nil
default['cassandra']['opscenter']['agent']['install_dir'] = '/opt'
default['cassandra']['opscenter']['agent']['install_folder_name'] = 'datastax_agent'
default['cassandra']['opscenter']['agent']['binary_name'] = 'datastax-agent'
